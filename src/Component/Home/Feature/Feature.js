        ...
        <section className='featureContainer'>
            <div style={{ height: '550px', width: '100%' }} className='row d-flex align-items-center'>
                <div className="col-md-6 offset-md-3 text-center ">
                    ...
                    <p className='text-white mb-5'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eaque commodi quas voluptates iusto impedit illum accusantium consectetur voluptate architecto optio!</p>
